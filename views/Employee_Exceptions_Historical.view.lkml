  view: gdh_gfs {
    derived_table: {
      sql:SELECT UPPER(interface_name) as interface_name ,UPPER(interface_type) as interface_type,rule_column,severity,error_description,global_group_id as ggid,"Not available in Interface" as pernr,ou_code,country_of_company,created_timestamp FROM
            ...
            SELECT UPPER(interface_name), interface_type,rule_column,severity,error_description,global_group_id as ggid, pernr_id,ou_code,country_of_company, created_timestamp as dc_created_timestamp FROM datacloud_adm_dq.dtsi_employee_dq_error_details
           UNION ALL
          SELECT UPPER(interface_name), interface_type,rule_column,severity,error_description,global_id as ggid,"Not Available in Interface" pernr_id,ou_code,country_of_company, created_timestamp as dc_created_timestamp FROM datacloud_adm_dq.gras_savoye_employee_dq_error_details
           UNION ALL
      ...
      UNION ALL
      SELECT "UKRAINE_CUBE" as interface_name, "INBOUND" as interface_type,rule_column,severity,error_description, ggid, ou_code,"Not Available in Interface"  AS pernr_id,  country_of_company,dc_created_timestamp FROM hr_dq.cube_employee_master_dq_error_details
      UNION ALL
      SELECT "COSTARICA" as interface_name, "INBOUND" as interface_type,rule_column,severity,error_description,GLOBAL_ID as ggid, ou_code,"Not Available in Interface"  AS pernr_id,  country_of_company,dc_created_timestamp FROM hr_dq.costarica_employee_master_dq_error_details
      UNION ALL
       SELECT "GREECE" as interface_name, "INBOUND" as interface_type,rule_column,severity,error_description,GLOBAL_ID as ggid, ou_code,"Not Available in Interface"  AS pernr_id,  country_of_company,dc_created_timestamp FROM hr_dq.greece_employee_master_dq_error_details
      UNION ALL
      SELECT "RBI_BRAZIL" as interface_name, "INBOUND" as interface_type,rule_column,severity,error_description,GLOBAL_ID as ggid, ou_code,"Not Available in Interface"  AS pernr_id,  country_of_company,dc_created_timestamp FROM hr_dq.rdi_brazil_employee_master_dq_error_details
      UNION ALL
      SELECT "RBI_HUNGARY" as interface_name, "INBOUND" as interface_type,rule_column,severity,error_description,GLOBAL_ID as ggid, ou_code,"Not Available in Interface"  AS pernr_id,  country_of_company,dc_created_timestamp FROM hr_dq.rdi_hungary_employee_master_dq_error_details
      UNION ALL
       SELECT "COLOMBIA" as interface_name, "INBOUND" as interface_type,rule_column,severity,error_description,GLOBAL_ID as ggid, ou_code,"Not Available in Interface"  AS pernr_id,  country_of_company,dc_created_timestamp FROM hr_dq.colombia_employee_master_dq_error_details
      UNION ALL
      SELECT "SOGETIUSA" as interface_name, "INBOUND" as interface_type,rule_column,severity,error_description,GLOBAL_ID as ggid, ou_code,"Not Available in Interface"  AS pernr_id,  country_of_company,dc_created_timestamp FROM hr_dq.sogetiusa_employee_master_dq_error_details
      UNION ALL
      SELECT "ARGENTINA" as interface_name, "INBOUND" as interface_type,rule_column,severity,error_description,GLOBAL_ID as ggid, ou_code,"Not Available in Interface"  AS pernr_id,  country_of_company,dc_created_timestamp FROM hr_dq.argentina_employee_master_dq_error_details
      UNION ALL
      SELECT "SPAIN_NEW_PORTAL" as interface_name, "INBOUND" as interface_type,rule_column,severity,error_description,global_group_id as ggid,"NOT AVAILABLE IN INTERFACE" AS pernr_id,ou_code,country_of_company, created_timestamp as dc_created_timestamp FROM datacloud_adm_dq.spain_new_portal_employee_dq_error_details
      UNION ALL
      SELECT "CAMBRIDGE" as interface_name, "INBOUND" as interface_type,rule_column,severity,error_description,GLOBAL_ID as ggid,"NOT AVAILABLE IN INTERFACE" AS pernr_id,ou_code,Country_of_Company, dc_created_timestamp FROM hr_dq.cambridge_employee_master_dq_error_details
      UNION ALL
