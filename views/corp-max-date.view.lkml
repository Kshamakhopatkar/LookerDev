view: corp_max_date {
  derived_table: {
    sql:select ifnull(created_timestamp,'1900-01-01')  as latest_refresh_date from `premi0570223-dc4prd.datacloud_adm_dq.corp_employee_dq_active_error_details` order by
