...
(pernr in(select distinct pernr from hr_curated.vw_cost_rate_code where crc is null) and rule_column = 'qualification') and  FORMAT_DATE('%Y-%m-%d', created_timestamp) not between '2024-07-01' and '2024-07-08'
      ...
      where rule_column<>'qualification' and  FORMAT_DATE('%Y-%m-%d', created_timestamp) not between '2024-07-01' and '2024-07-08'
      UNION ALL
      ...
      UNION ALL
      SELECT "SFEC_Job" as interface_name ,"INBOUND" as interface_type,rule_column,"Not available in interface" as severity, "Not available in interface" as ggid,error_description,"Not available in interface" as ou_code,"Not available in interface" as  pernr_id,company_code as country_of_company ,"Not available in interface" as employee_status_code, timestamp(blocked_since) as dc_created_timestamp FROM hr_dq.sfec_job_position_master_active_dq_error_details where FORMAT_DATE('%Y-%m-%d', blocked_since) not between '2024-07-01' and '2024-07-08'
      UNION ALL
      ...
      union all
      SELECT "SFEC_Voluntary" as interface_name ,"INBOUND" as interface_type,rule_column,"Not available in interface" as severity,"Not available in interface" as ggid,error_description,"Not available in interface" as ou_code, pernr as pernr_id ,country_of_company,"Not available in interface" as employee_status_code, blocked_since as dc_created_timestamp FROM hr_dq.sfec_voluntary_separation_active_dq_error_details where FORMAT_DATE('%Y-%m-%d', blocked_since) not between '2024-07-01' and '2024-07-08'
      UNION ALL
      SELECT UPPER(interface_name) as interface_name ,UPPER(interface_type) as interface_type,rule_column, severity, global_group_id as ggid,error_description,ou_code, pernr_id,country_of_company, "Not available in interface" as employee_status_code, created_timestamp as dc_created_timestamp FROM
