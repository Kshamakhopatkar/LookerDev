view: consolidation_historical_gfs {
  ...
  SELECT "GFS_TASK" as interface_name,"INBOUND" as interface_type,rule_column,SUBSTR(severity, 10) as severity,error_description,ou_code,project_number,dc_created_timestamp FROM finance_dq.gfs_task_dq_error_details
    UNION ALL
  SELECT "REPLICON" as interface_name,"OUTBOUND" as interface_type,rule_column,SUBSTR(severity, 10) as severity,error_description, ou_code,Project_code as project_number,created_timestamp as dc_created_timestamp FROM datacloud_adm_dq.replicon_project_dq_error_details
  UNION ALL
    SELECT "GFS_PROJECT" as interface_name,"OUTBOUND" as interface_type,"" as rule_column,"" as severity,"DUMMY Exception inserted to handle No Exception Scenario" as error_description,"" as ou_code,"" as project_number,timestamp("1900-01-01") as dc_created_timestamp
    UNION ALL
    SELECT "GFS_PROJECT_CLASSIFICATION" as interface_name,"OUTBOUND" as interface_type,"" as rule_column,"" as severity,"DUMMY Exception inserted to handle No Exception Scenario" as error_description,"" as ou_code,"" as project_number,timestamp("1900-01-01") as dc_created_timestamp
    UNION ALL
    SELECT "GFS_PROJECT_MEMBER" as interface_name,"OUTBOUND" as interface_type,"" as rule_column,"" as severity,"DUMMY Exception inserted to handle No Exception Scenario" as error_description,"" as ou_code,"" as project_number,timestamp("1900-01-01") as dc_created_timestamp
    UNION ALL
    SELECT "GFS_PROVIDER_OU" as interface_name,"OUTBOUND" as interface_type,"" as rule_column,"" as severity,"DUMMY Exception inserted to handle No Exception Scenario" as error_description,"" as ou_code,"" as project_number,timestamp("1900-01-01") as dc_created_timestamp
  UNION ALL
