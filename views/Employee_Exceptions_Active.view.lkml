...
=======
           SELECT UPPER(interface_name) ,UPPER(interface_type) as interface_type,rule_column, severity, global_group_id as ggid,error_description,ou_code, pernr_id,country_of_company, employee_number as employee_status_code, created_timestamp as dc_created_timestamp FROM
>>>>>>> branch 'master' of git@github.com:aroramohit01/looker_connect_UAT.git
