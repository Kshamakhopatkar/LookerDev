view: sfec_location_master_dq_error_details {
  sql_table_name: `premi0436563-gitenter.hr_dq.sfec_location_master_dq_error_details` ;;
  ...
  dimension: office_location_code {
    type: string
    sql: ${TABLE}.Office_Location_code ;;
  }
  dimension: ou_code {
    type: string
    sql: ${TABLE}.ou_code ;;
